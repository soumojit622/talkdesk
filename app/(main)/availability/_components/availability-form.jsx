  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Button
        type="submit"
        disabled={loading}
        className="bg-gradient-to-r from-violet-600 to-blue-500 text-white hover:from-violet-700 hover:to-blue-600 focus:outline-none focus:ring focus:ring-purple-300 transition duration-200 py-2 rounded-md shadow-sm transform hover:scale-105 hover:shadow-lg"
      >
